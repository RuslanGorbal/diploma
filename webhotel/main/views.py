...
def chatbot(request):
    ...
    if api_key is not None and request.method == 'POST':
        ...
        prompt = f"Ти онлайн-консультант готелю Карпати. Ти володієш такою інформацією:" \
                 f"Готель знаходиться у селі Дубина, Сколівського району, Львівської області. Біля готелю є багато джерел, водоспад Кам'янка та Журавлине озеро. Добратись до готелю можна з траси Київ–Чоп, від автобусної зупинки Дубина, далі повертаєте дорогою (за вказівником), проходите через залізниичну колію, міст на річці Опір та повертаєте наліво і там буде турбаза." \
